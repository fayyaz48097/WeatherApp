...
function App() {
  ...
  const fetchWeather = () => {
    ...
    axios
      ...
      .catch((error) => {
        ...
        setLoading(false);
        setData(null); // Set data to null on error to handle the state correctly
      });
  };
  ...
  // This block handles the initial loading state
  if (loading) {
    return (
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        {/* Conditionally render the weather card only if 'data' exists */}
        {data && (
        ...
        {/* Optional: Add a message for when data is not available */}
        {!data && !loading && (
          <div className="p-8 text-center text-gray-500 rounded-xl shadow-md">
            No weather data available. Please select a country.
          </div>
        )}
      </div>
    </div>
